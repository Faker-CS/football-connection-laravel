...
<div class="stats-grid">
    @foreach($stats as $stat)
        <x-stat-card :icon="$stat['icon']" :color="$stat['color']" :value="$stat['value']" :label="$stat['label']" :trend="$stat['trend'] ?? null" :trendDir="$stat['trend_dir'] ?? null" :badge="$stat['badge'] ?? null" :badgeColor="$stat['badge_color'] ?? null" />
    @endforeach
</div>
...
<div class="grid-2">
        ...
        <div class="card-body" style="padding:0">
            ...
            <div style="padding:1rem 1.5rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:1rem">
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <div class="text-muted text-sm">{{ $offer['type'] }} · {{ $offer['location'] }} · {{ $offer['salary'] }}</div>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:0">
            ...
            <div style="padding:1rem 1.5rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:.85rem">
...
<div class="card mt-2">
    <div class="card-header">
        ...
        <a href="{{ route('club.talents') }}" class="link-green">Voir tout →</a>
    </div>
    <div class="card-body">
        <div class="grid-3">
