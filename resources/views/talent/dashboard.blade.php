...
@section('content')
    ...
    <div class="welcome-banner">
        ...
        <div class="welcome-cta">
            <a href="{{ route('talent.profile') }}" class="btn btn-primary btn-lg">Compléter mon profil</a>
            <a href="{{ route('talent.opportunities') }}" class="btn btn-outline btn-lg">Explorer les opportunités</a>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:0">
                @foreach ($recent_applications as $app)
                    <div
                        style="padding:1rem 1.5rem;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between">
                        <div>
