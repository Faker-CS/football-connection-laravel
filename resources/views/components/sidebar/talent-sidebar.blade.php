<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('talent.dashboard') }}"
            class="nav-item {{ request()->routeIs('talent.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('talent.profile') }}"
            class="nav-item {{ request()->routeIs('talent.profile') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('talent.publications') }}"
            class="nav-item {{ request()->routeIs('talent.publications') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="nav-section-label">Opportunités</div>
        <a href="{{ route('talent.applications') }}"
            class="nav-item {{ request()->routeIs('talent.applications') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('talent.settings') }}"
            class="nav-item {{ request()->routeIs('talent.settings') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
