<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('club.offers.create') }}" class="nav-item {{ request()->routeIs('club.offers.create') ? 'active' : '' }}">
        ...
        <a href="{{ route('club.applications') }}" class="nav-item {{ request()->routeIs('club.applications') ? 'active' : '' }}">
        ...
        <a href="{{ route('club.talents') }}" class="nav-item {{ request()->routeIs('club.talents') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
            Rechercher des talents
        </a>
        <div class="nav-section-label" style="margin-top:1rem">Paramètres</div>
        <a href="{{ route('club.settings') }}" class="nav-item {{ request()->routeIs('club.settings') ? 'active' : '' }}">
