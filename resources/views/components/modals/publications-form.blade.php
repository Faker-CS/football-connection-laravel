...
<x-modal id="publicationFormModal" title="Ajouter une publication" size="lg">
  <form id="publicationForm">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-input" id="pubTitle" name="title" placeholder="Ex: Séance tactique U17 — Pressing haut" required>
    </div>

    {{-- Description --}}
    <div class="form-group">
      <label class="form-label">Description</label>
      <textarea class="form-input" id="pubDesc" name="description" rows="3" placeholder="Décrivez votre publication..." required></textarea>
    </div>
    ...
    <div class="pub-field-video" style="display:none;">
      <div class="form-group">
        ...
        <input type="url" class="form-input" id="pubVideoUrl" name="video_url" placeholder="https://youtube.com/watch?v=...">
      </div>
      <div class="form-row">
        <div class="form-group">
          <label class="form-label">Durée <span class="form-hint">(ex: 3:42)</span></label>
          <input type="text" class="form-input" id="pubVideoDuration" name="video_duration" placeholder="0:00">
        </div>
        <div class="form-group">
          <label class="form-label">Vignette <span class="form-hint">(optionnel)</span></label>
          <input type="url" class="form-input" id="pubVideoThumb" name="video_thumb" placeholder="URL de la vignette">
        </div>
      </div>
    </div>
    ...
    <div class="pub-field-article">
      <div class="form-group">
        ...
        <textarea class="form-input" id="pubArticleContent" name="article_content" rows="5" placeholder="Rédigez votre article ici..."></textarea>
      </div>
      <div class="form-group">
        <label class="form-label">Image de couverture <span class="form-hint">(optionnel)</span></label>
        <div class="upload-zone" onclick="document.getElementById('pubArticleImg').click()" style="border:2px dashed var(--border);border-radius:var(--radius-sm);padding:2rem;text-align:center;color:var(--muted);cursor:pointer;transition:all var(--transition);">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;margin:0 auto 0.5rem;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
        ...
        <div id="pubArticleImgPreview" style="display:none;margin-top:.6rem;border-radius:10px;overflow:hidden;height:100px;"><img style="width:100%;height:100%;object-fit:cover;"></div>
      </div>
    </div>
      ...
      <div class="form-group">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
          ...
          <div>
            ...
            <input type="text" class="form-input" name="stat1_label" placeholder="Ex: Taux de possession">
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" class="form-input" name="stat3_label" placeholder="Ex: Système de jeu">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="pub-field-gallery" style="display:none;">
      <div class="form-group">
        ...
        <div class="upload-zone" onclick="document.getElementById('pubGalleryFiles').click()" style="border:2px dashed var(--border);border-radius:var(--radius-sm);padding:2rem;text-align:center;color:var(--muted);cursor:pointer;transition:all var(--transition);">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;margin:0 auto 0.5rem;"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
          ...
          <input type="file" id="pubGalleryFiles" accept="image/*" multiple onchange="previewGalleryImages(this)">
        </div>
    ...
    <div class="form-group" style="display:flex;align-items:center;justify-content:space-between;padding:.85rem 1rem;background:#f9faf9;border-radius:10px;border:1px solid var(--border);">
      <div>
        ...
        <div style="font-size:.78rem;color:var(--muted);margin-top:.1rem;">Visible sur votre profil public et par les clubs connectés</div>
      </div>
      <label class="toggle">
    ...
    <div style="display: flex; gap: 0.75rem; margin-top: 1.5rem;">
      <button type="button" class="btn btn-outline" style="flex: 1;" onclick="ModalManager.close('publicationFormModal')">
        Annuler
      </button>
  ...
  if (input.files) {
    ...
    for (let i = 0; i < files; i++) {
      ...
      reader.onload = function(e) {
        ...
        thumb.style.cssText = 'width:80px;height:80px;border-radius:8px;overflow:hidden;flex-shrink:0;';
